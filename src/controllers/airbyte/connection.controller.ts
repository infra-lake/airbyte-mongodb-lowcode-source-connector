...
//     public constructor() {
//         fs.readdirSync('./templates/airbyte/connection').forEach(_compile)
//     }
...
//     }
//     const template = fs.readFileSync(`./templates/airbyte/connection/${version}/template.hbs`).toString('utf-8')
